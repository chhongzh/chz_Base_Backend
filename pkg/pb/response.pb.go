...
type OpenOAuthResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SignSessionID string                 `protobuf:"bytes,1,opt,name=signSessionID,proto3" json:"signSessionID,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *OpenOAuthResponse) Reset() {
	*x = OpenOAuthResponse{}
...
func (x *OpenOAuthResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OpenOAuthResponse) ProtoMessage() {}

func (x *OpenOAuthResponse) ProtoReflect() protoreflect.Message {
	mi := &file_response_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OpenOAuthResponse.ProtoReflect.Descriptor instead.
func (*OpenOAuthResponse) Descriptor() ([]byte, []int) {
	return file_response_proto_rawDescGZIP(), []int{1}
}

func (x *OpenOAuthResponse) GetSignSessionID() string {
	if x != nil {
		return x.SignSessionID
	}
	return ""
}

type VerifyApplicationSecretResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *VerifyApplicationSecretResponse) Reset() {
	*x = VerifyApplicationSecretResponse{}
	mi := &file_response_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VerifyApplicationSecretResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VerifyApplicationSecretResponse) ProtoMessage() {}

func (x *VerifyApplicationSecretResponse) ProtoReflect() protoreflect.Message {
	mi := &file_response_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VerifyApplicationSecretResponse.ProtoReflect.Descriptor instead.
func (*VerifyApplicationSecretResponse) Descriptor() ([]byte, []int) {
	return file_response_proto_rawDescGZIP(), []int{2}
}

func (x *VerifyApplicationSecretResponse) GetIsValid() bool {
	if x != nil {
		return x.IsValid
	}
	return false
...
func (x *CommitActionResponse) Reset() {
	*x = CommitActionResponse{}
	mi := &file_response_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CommitActionResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CommitActionResponse) ProtoMessage() {}

func (x *CommitActionResponse) ProtoReflect() protoreflect.Message {
	mi := &file_response_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CommitActionResponse.ProtoReflect.Descriptor instead.
func (*CommitActionResponse) Descriptor() ([]byte, []int) {
	return file_response_proto_rawDescGZIP(), []int{3}
}

func (x *CommitActionResponse) GetIsOk() bool {
	if x != nil {
		return x.IsOk
	}
	return false
...
const file_response_proto_rawDesc = "" +
	...
	"\rhasPermission\x18\x01 \x01(\bR\rhasPermission\"9\n" +
	"\x11OpenOAuthResponse\x12$\n" +
	"\rsignSessionID\x18\x01 \x01(\tR\rsignSessionID\";\n" +
	"\x1fVerifyApplicationSecretResponse\x12\x18\n" +
	"\aisValid\x18\x01 \x01(\bR\aisValid\"*\n" +
	"\x14CommitActionResponse\x12\x12\n" +
	"\x04isOk\x18\x01 \x01(\bR\x04isOkB-Z+github.com/chhongzh/chz_Base_Backend/pkg/pbb\x06proto3"
...
var file_response_proto_goTypes = []any{
	...
	(*OpenOAuthResponse)(nil),               // 1: pb.OpenOAuthResponse
	(*VerifyApplicationSecretResponse)(nil), // 2: pb.VerifyApplicationSecretResponse
	(*CommitActionResponse)(nil),            // 3: pb.CommitActionResponse
}
